	...
	<div class="container text-left w-50 body__margin-top">
		<section id="writeForm">
			<div class="text-center m-3 ">
				<form action="noticeReplyPro.do" method="post" name="noticeform">
					...
					<div class="form-col">
						...
						<div class="form-group col-md-2">
							<label for="notice_pass">비밀번호</label> <input name="notice_pass"
								type="password" id="notice_pass" />
						</div>
						<div class="form-group col-md-2">
							<label for="notice_subject">제 목</label> <input
								name="notice_subject" type="text" id="notice_subject" />
						</div>
						<div class="form-group col-md-6">
							<label for="notice_content">내 용</label>
							<textarea class="form-control is-invalid" id="validationTextarea"
								name="notice_content" placeholder="내용을 적어 주세요." cols="40"
